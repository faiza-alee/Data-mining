This repository demonstrates the implementation of neural networks using the MNIST dataset,which consists of handwritten digits. The project explores various architectures,
